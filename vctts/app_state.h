...
struct AppState {
    ...
    std::vector<std::wstring> systemVoices;
    int systemVoiceIndex = 0;
    std::vector<std::wstring> phonomenalVoices;
    int phonomenalVoiceIndex = 0;

    // ---- Custom TTS ----
    char customTtsCommand[1024] = "";

    std::mutex phonomenalStatusMutex;
    std::string phonomenalStatus;
    // ---- Phonomenal ----
    char phonomenalBankDirectory[1024] = "";
